...
| `engineering-operating-system` | Auditar e desenhar o sistema operacional de engenharia de um produto: contexto, arquitetura, workflow, qualidade, release, seguranca, dados, operacoes, docs e cadencia. Inclui subcomandos `eos:*`. | Criada neste repo a partir do livro `Software Development 101` |
